...
function AdminUnavailable() {
    ...
    const API2 = URL + 'api/puppie/status/Unavailable';
    useEffect(() => {
        if (!loggedIn) {
    ...
    return (
        <>
            <Navbar adminUnavailable={"active"} />
            <PageHeader title={["Hi Admin", "Hello Montana", "Welcome to Company Name", "Welcome to your Unavailable Puppies"]}
